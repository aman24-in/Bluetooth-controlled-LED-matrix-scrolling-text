...
//      frameDelay = speed;     //(*)
      ...
      int speed1 = 70;        //COMMENT these lines to use variable resistor as the scrolling speed controller (**) <- the smaller the value, the faster scrolling speed would be   
      P.setSpeed(speed1);     //(**)
      P.setPause(speed1);     //(**)
      frameDelay = speed1;    //(**)
